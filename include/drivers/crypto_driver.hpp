...
public:
  ...
  std::tuple<SecByteBlock, SecByteBlock>
  rachet_key(const SecByteBlock &DH_shared_key, const SecByteBlock &root_key);

  SecByteBlock AES_generate_key(const SecByteBlock &DH_shared_key, const SecByteBlock &chain_key);
  ...
  SecByteBlock HMAC_generate_key(const SecByteBlock &DH_shared_key, const SecByteBlock &chain_key);
